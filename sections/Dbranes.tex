...
If we are to impose the supersymmetric condition on an ansatz, it can provide us with first order differential equations, which are easier to solve instead of the standard second order equations of motion from the D-brane action. Here we will outline our strategy to solve the supersymmetric condition under certain conditions.
