...
\end{align}
The brane wraps the three dimensional ellipsoid of the deformed $S^5$ sector of the Pilch-Warner metric.
...
\comment{Talk about the geometry and why the divergence at cmax, i.e. enhancon \cite{Buchel:2000cn} and \cite{Evans:2000ct}}
\begin{figure}[t]
\begin{center}
